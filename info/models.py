...
time_slots = (
    ...
    ('8:30 - 10:50', '8:30 - 09:50'),
    ('10:00 - 11:20', '10:00 - 11:20'),
    ('11:50 - 13:10', '11:50 - 13:10'),
    ('13:20 - 14:40', '13:20 - 14:40'),
    ('14:50 - 16:10', '14:50 - 16:10'),
    #('16:20 - 17:40', '16:20 - 17:40'),
    #('17:50 - 18:10', '17:50 - 18:10'),
    #('18:20 - 19:40', '18:20 - 19:40'),
    #('19:50 - 20:10', '19:50 - 20:10'),
...
test_name = (
    ...
    ('Поточна 2', 'Поточна 2'),
    ('Поточна 3', 'Поточна 3'),
    ('Атестація 1', 'Атестація 1'),
    ('Атестація 2', 'Атестація 2'),
...
class AssignTime(models.Model):
    ...
    period = models.CharField(max_length=50, choices=time_slots, default='08:30 - 09:50')
...
class Marks(models.Model):
    ...
    name = models.CharField(max_length=50, choices=test_name, default='Поточна 1')
    marks1 = models.IntegerField(default=2, validators=[MinValueValidator(2), MaxValueValidator(5)])
        ...
        if hasattr(instance, 'name'):
            ...
            for ass in ass_list:
                try:
                    ...
                    sc.save()
                    sc.marks_set.create(name='Поточна 1')
                    sc.marks_set.create(name='Поточна 2')
                    sc.marks_set.create(name='Поточна 3')
                    sc.marks_set.create(name='Атестація 1')
                    sc.marks_set.create(name='Атестація 2')
                    sc.marks_set.create(name='Семестрова')
